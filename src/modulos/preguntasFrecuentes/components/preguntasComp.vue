...
const preguntas = [
  ...
  },
  {
    num: 2,
    pregunta:
      "¿Quiénes proporcionan la información del Cuestionario curricular de cada persona candidata?",
    respuesta:
      "La información es proporcionada por las personas candidatas contendientes.",
  },
  {
    num: 3,
    pregunta:
